...
impl Plugin for TerrainPlugin {
    fn build(&self, app: &mut App) {
        ...
        #[cfg(not(feature = "skip_terrain"))]
        {
            ...
            app.add_systems(OnEnter(GameState::Playing), terrain_systems::prepare_spawn_area_system);
            app.add_systems(OnEnter(GameState::Playing), terrain_systems::generate_world_system);
            app.add_systems(
                Update,
